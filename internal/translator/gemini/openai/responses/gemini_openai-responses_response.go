...
type geminiToResponsesState struct {
	...
	// RequestJSON caches the parsed downstream request body so later stream
	// chunks do not re-parse potentially large media-bearing payloads (fork).
	RequestJSON []byte
}
